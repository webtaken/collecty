...
export function EditWidgetModal({ children, open, onOpenChange }: EditWidgetModalProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[95vw] w-[95vw] min-w-[95vw] h-[90vh] p-0 flex flex-col overflow-hidden bg-slate-50/50">
                <div className="flex flex-1 h-full overflow-hidden">
                    ...
                    {/* Right: Preview Area */}
                    <div className="flex-1 flex flex-col items-center justify-center p-8 bg-slate-100/50 overflow-hidden relative">
