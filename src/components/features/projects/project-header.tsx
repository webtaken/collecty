...
export function ProjectHeader({ project }: ProjectHeaderProps) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
      ...
      <div
        className="bg-white rounded-xl border border-slate-200 shadow-sm p-5 h-full"
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 h-full min-h-[200px] flex flex-col">
        ...
        <div
          className="bg-slate-50/50 rounded-lg border border-slate-200 p-1.5 flex-1 min-h-0 relative"
