...
export function WidgetInstall() {
  ...
  const handleCopyCode = async () => {
    ...
    try {
      publishGuideEvent(
        isPopupActive ? "guide:copiedPopup" : "guide:copiedInline",
      );
    } catch {}
  ...
  const renderCodeBlock = (
    ...
    <div className="relative">
      <SyntaxHighlighter
        language={language || frameworkData?.language || "javascript"}
        style={vscDarkPlus}
        customStyle={{
          margin: 0,
          borderRadius: "0.5rem",
          ...
          <div className="space-y-1">
                  ...
                  <PopoverContent className="w-80" align="start">
                    <div className="space-y-3">
                      ...
                      <p className="text-xs text-slate-600">
                        Use these helper functions to control the widget
                        programmatically:
                      </p>
            ...
            <p className="text-sm text-slate-600">
              {frameworkData?.description ||
                "Get your installation code below."}
            </p>
          </div>
        </div>
      </div>
        ...
        <Tabs defaultValue="script" className="w-full">
          ...
          {!isPopupActive && (
            <TabsContent value="html" className="mt-4 space-y-4">
              <p className="text-sm text-slate-600">
                Get a self-contained HTML snippet with all styles included. Best
                for static sites or email builders.
              </p>
